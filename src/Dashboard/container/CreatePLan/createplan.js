              ...
              <Box sx={{ width: "100%" }}>
                ...
                >
                  <Grid xs={6}>
                    ...
                    >
                      <div className="d-flex align-center fs-15 fw-bold mt-10">
                        <span className="c-grey">plan id :</span>12
                      </div>
                      <div className="d-flex align-center fs-15 fw-bold mt-10">
                        <span className="c-grey">plan name :</span>
                        {planName}
                      </div>
                      <div className="d-flex align-center fs-15 fw-bold mt-10">
                        <span className="c-grey">plan size :</span>12
                      </div>
                    </div>
                  </Grid>
                  <Grid xs={6}>
                    ...
                    >
                      <div className="d-flex align-center fs-15 fw-bold mt-10">
                        <span className="c-grey">execution time :</span>
                        {planDateTime}
                      </div>
                      <div className="d-flex align-center fs-15 fw-bold mt-10">
                        <span className="c-grey">Rover id :</span>RVR1233Q
                      </div>
                      <div className="d-flex align-center fs-15 fw-bold mt-10">
                        <span className="c-grey">Rover status :</span>12
                      </div>
                    </div>
                  </Grid>
                  {/* <Grid xs={6}>
                ...
                <>
                  <Stack direction="row" spacing={2}>
                    <Button
                      ...
                      onClick={() => {
                        dispatch(
                          replace2elements({ fromIndex: 1, toIndex: 3 })
                        );
                      }}
