      ...
      <div className="editinfo p-20 bg-white rad-10 bs">
        <div className="mb-15 between-flex">
          <div className="p-10 bg-white rad-10" style={{ width: "72%" }}>
            ...
            <p>
              commend id :<b>{PlanCommendData.subSystemId}</b> subsystem id:
              <b>{PlanCommendData.commandID}</b>
            </p>
            <div className="mb-15">
              ...
              <input
                ...
                placeholder="0"
                onChange={(repeat) => {
                  dispatch(TakeRepeat({ repeat: repeat.target.value }));
                }}
              />
            </div>
            <div className="mb-15">
              ...
              <input
                ...
                placeholder="0"
                onChange={(delay) => {
                  dispatch(TakeDelay({ delay: delay.target.value }));
                }}
              />
            </div>
          </div>
        ...
        <div style={{ textAlign: "right" }}>
          <a
            className="button bg-blue c-white btn-shape ml-10"
            onClick={() => {
